-- INCREMENTAL MIGRATION - Section 8 (Data Migration) - UPDATED
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE '';
  RAISE NOTICE 'NOTE: repair_order_notes table was skipped';
  RAISE NOTICE 'You can create it later when repair_orders table exists';
  RAISE NOTICE '========================================';
END $$;
